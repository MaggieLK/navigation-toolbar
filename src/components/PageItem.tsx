  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseEnter={() =>
          hoveredPageId !== page.id && hoveredPageId === null && !draggedPageId && setHoveredPageId(page.id)
        }
        ...
        className={`
          ...
          ${activePageId === page.id ? 'bg-white' : 'bg-[#9DA4B2]/15 hover:bg-[#9DA4B2]/35 shadow-sm'}
          ${
            showDotsIcon
          ...
          ${activePageId === page.id && !showDotsIcon ? 'border-[0.5px] border-[rgba(225, 225, 225, 1)]' : ''}
          relative z-20
      ...
      >
        ...
        {page.id === '1' ? (
          <svg
            className={`w-5 h-5 ${activePageId === page.id ? 'stroke-[#F59D0E]' : 'stroke-gray-500'} mr-[6px]`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
            <path
              ...
              strokeWidth="2"
              d="M12 11v5m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
            ></path>
          </svg>
        ) : page.id === '4' ? (
          <svg
        ...
        {editingPageId === page.id ? (
          ...
          <span
            className={`truncate font-inter font-medium text-sm leading-tight tracking-tighter text-center ${activePageId === page.id ? 'text-[#1A1A1A]' : 'text-[#677289]'}`}
          >
            {page.name}
          </span>
        )}
